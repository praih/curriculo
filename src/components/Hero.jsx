    ...
    mx-auto">
      ...
      flex-row items-start gap-5`}>
        ...
        justify-center items-center mt-5">
          ...
          <div>
            <h1 className={`${styles.heroHeadText}text-white`}>Oi, Eu sou o <span className="text-[#915eff]">João</span></h1>
            <p className={`${styles.heroSubText} mt-2
            text-white-100`}>
              Eu desenvolvo Websites, Aplicativos Web e muitos outros serviços
            </p>
        </div>
      </div>
        <ComputersCanvas />

        <div className="absolute xs:buttom-10
